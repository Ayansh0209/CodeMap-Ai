      ...
      <div className="glow-border rounded-2xl bg-surface p-1.5 transition-all duration-300">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
          <div className="flex items-center flex-1 gap-2">
            {/* GitHub icon */}
            <div className="pl-3 sm:pl-4 text-muted shrink-0">
            ...
            <input
              ...
              disabled={isLoading}
              className="flex-1 bg-transparent py-2.5 sm:py-3.5 text-foreground placeholder:text-muted/60 outline-none font-mono text-xs sm:text-sm"
              autoComplete="off"
              spellCheck={false}
            />
          </div>
          ...
          <button
            ...
            type="submit"
            disabled={isLoading}
            className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-primary text-white font-medium text-sm
