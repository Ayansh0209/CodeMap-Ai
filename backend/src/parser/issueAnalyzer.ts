...
If implementing the fix would require adding or updating tests, and relevant test files appear in the snippets above, include ALL relevant test file(s) in affectedFiles with a reason noting they are tests to add/update (never invent test files not shown above).
