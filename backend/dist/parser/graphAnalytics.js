...
function detectCircularDependencies(fileNodes, importEdges) {
    let index = 0;
    const stack = [];
...
function calculateDependencyWeights(fileNodes, importEdges) {
